      ...
      return (
        <tr>
          ...
          <td className="px-4 py-4 text-sm whitespace-nowrap">
            <Link href={'/admin/issue-badge/' + student._id} className="px-1 py-1 text-white bg-blue-600 px-6 py-3 transition-colors duration-200 rounded-lg dark:text-gray-300">
              View
            </Link>
          </td>
        </tr>
